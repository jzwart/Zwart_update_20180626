...
sensordbTable<-function(table,fpath=file.path('C:/Users/Jake/Documents/Jake/Database'),
  ...
  if(!is.null(table$dateTime)){
    table$dateTime<-as.POSIXct(table$dateTime,tz='GMT') # changing from character to POSIXct
  if(!is.null(minDate)){
...
sensordbTableList<-function(fpath=file.path('C:/Users/Jake/Documents/Jake/Database'),
